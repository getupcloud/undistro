...
//
//A list of changes since v1alpha1:
...
//
// Please convert your v1alpha1 configuration files to v1beta1 using the "kubeadm config migrate" command of kubeadm v1.13.x
// (conversion from older releases of kubeadm config files requires older release of kubeadm as well e.g.
//	kubeadm v1.11 should be used to migrate v1alpha2 to v1alpha2; kubeadm v1.12 should be used to translate v1alpha2 to v1alpha1)
//
// Nevertheless, kubeadm v1.13.x will support reading from v1alpha1 version of the kubeadm config file format, but this support
...
//
package v1beta1 // import "github.com/getupcloud/undistro/third_party/kubeadm/types/v1beta1"
