...
type ManagementCluster interface {
	...
	TargetClusterEtcdIsHealthy(ctx context.Context, clusterKey ctrlclient.ObjectKey) error
	TargetClusterControlPlaneIsHealthy(ctx context.Context, clusterKey ctrlclient.ObjectKey) error
...
func (m *Management) healthCheck(ctx context.Context, check healthCheck, clusterKey ctrlclient.ObjectKey) error {
	var errorList []error
...
func (m *Management) TargetClusterControlPlaneIsHealthy(ctx context.Context, clusterKey ctrlclient.ObjectKey) error {
...
func (m *Management) TargetClusterEtcdIsHealthy(ctx context.Context, clusterKey ctrlclient.ObjectKey) error {
	cluster, err := m.GetWorkloadCluster(ctx, clusterKey)
	if err != nil {
		return err
	}
