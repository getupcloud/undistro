...
func (m *Management) Get(ctx context.Context, key client.ObjectKey, obj runtime.Object) error {
	return m.Client.Get(ctx, key, obj)
}

// List implements ctrlclient.Reader
func (m *Management) List(ctx context.Context, list runtime.Object, opts ...client.ListOption) error {
