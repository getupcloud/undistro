...
const (
	KubeadmControlPlaneFinalizer = "kubeadm.controlplane.getupcloud.com"

	// DEPRECATED: This label has been deprecated and it's not in use anymore.
	KubeadmControlPlaneHashLabelKey = "kubeadm.controlplane.getupcloud.com/hash"

	// SkipCoreDNSAnnotation annotation explicitly skips reconciling CoreDNS if set
	SkipCoreDNSAnnotation = "controlplane.getupcloud.com/skip-coredns"

	// SkipKubeProxyAnnotation annotation explicitly skips reconciling kube-proxy if set
	SkipKubeProxyAnnotation = "controlplane.getupcloud.com/skip-kube-proxy"
	...
	KubeadmClusterConfigurationAnnotation = "controlplane.getupcloud.com/kubeadm-cluster-configuration"
)
