...
const (
	...
	ClusterLabelName = "cluster.getupcloud.com/cluster-name"
	...
	ProviderLabelName = "cluster.getupcloud.com/provider"
	...
	PausedAnnotation = "cluster.getupcloud.com/paused"
	...
	TemplateClonedFromNameAnnotation = "cluster.getupcloud.com/cloned-from-name"
	...
	// that was cloned for the machine. This annotation is set only during cloning a template. Older/adopted machines will not have this annotation.
	TemplateClonedFromGroupKindAnnotation = "cluster.getupcloud.com/cloned-from-groupkind"

	// ClusterSecretType defines the type of secret created by core components
	ClusterSecretType corev1.SecretType = "cluster.getupcloud.com/secret" //nolint:gosec
)
