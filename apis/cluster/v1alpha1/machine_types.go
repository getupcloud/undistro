...
const (
	...
	MachineFinalizer = "machine.cluster.getupcloud.com"

	// MachineControlPlaneLabelName is the label set on machines or related objects that are part of a control plane.
	MachineControlPlaneLabelName = "cluster.getupcloud.com/control-plane"

	// ExcludeNodeDrainingAnnotation annotation explicitly skips node draining if set
	ExcludeNodeDrainingAnnotation = "machine.cluster.getupcloud.com/exclude-node-draining"

	// MachineSetLabelName is the label set on machines if they're controlled by MachineSet
	MachineSetLabelName = "cluster.getupcloud.com/set-name"

	// MachineDeploymentLabelName is the label set on machines if they're controlled by MachineDeployment
	MachineDeploymentLabelName = "cluster.getupcloud.com/deployment-name"
)
...
type Bootstrap struct {
	...
	//
	// Deprecated: This field has been deprecated in v1alpha1 and
