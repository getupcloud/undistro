...
// +kubebuilder:webhook:verbs=create;update,path=/validate-cluster.getupcloud.com-v1alpha1-cluster,mutating=false,failurePolicy=fail,matchPolicy=Equivalent,groups=cluster.getupcloud.com,resources=clusters,versions=v1alpha1,name=validation.cluster.getupcloud.com,sideEffects=None
// +kubebuilder:webhook:verbs=create;update,path=/mutate-cluster.getupcloud.com-v1alpha1-cluster,mutating=true,failurePolicy=fail,matchPolicy=Equivalent,groups=cluster.getupcloud.com,resources=clusters,versions=v1alpha1,name=default.cluster.getupcloud.com,sideEffects=None
