...
// +kubebuilder:webhook:verbs=create;update,path=/validate-cluster.getupcloud.com-v1alpha1-machineset,mutating=false,failurePolicy=fail,matchPolicy=Equivalent,groups=cluster.getupcloud.com,resources=machinesets,versions=v1alpha1,name=validation.machineset.cluster.getupcloud.com,sideEffects=None
// +kubebuilder:webhook:verbs=create;update,path=/mutate-cluster.getupcloud.com-v1alpha1-machineset,mutating=true,failurePolicy=fail,matchPolicy=Equivalent,groups=cluster.getupcloud.com,resources=machinesets,versions=v1alpha1,name=default.machineset.cluster.getupcloud.com,sideEffects=None
