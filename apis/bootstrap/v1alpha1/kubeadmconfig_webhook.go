...
// +kubebuilder:webhook:verbs=create;update,path=/validate-bootstrap-getupcloud.com-v1alpha1-kubeadmconfig,mutating=false,failurePolicy=fail,matchPolicy=Equivalent,groups=bootstrap.getupcloud.com,resources=kubeadmconfigs,versions=v1alpha1,name=validation.kubeadmconfig.bootstrap.getupcloud.com,sideEffects=None
