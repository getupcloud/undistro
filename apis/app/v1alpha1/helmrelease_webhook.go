...
//+kubebuilder:webhook:path=/mutate-app-undistro-io-v1alpha1-helmrelease,mutating=true,failurePolicy=fail,sideEffects=None,groups=app.undistro.io,resources=helmreleases,verbs=create;update,versions=v1alpha1,name=mhelmrelease.kb.io,admissionReviewVersions={v1,v1beta1}
...
//+kubebuilder:webhook:path=/validate-app-undistro-io-v1alpha1-helmrelease,mutating=false,failurePolicy=fail,sideEffects=None,groups=app.undistro.io,resources=helmreleases,verbs=create;update,versions=v1alpha1,name=vhelmrelease.kb.io,admissionReviewVersions={v1,v1beta1}
