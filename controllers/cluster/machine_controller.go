...
import (
	...
	"github.com/getupcloud/undistro/controllers/cluster/external"
	"github.com/getupcloud/undistro/controllers/cluster/metrics"
	"github.com/getupcloud/undistro/controllers/cluster/noderefutil"
	"github.com/getupcloud/undistro/controllers/cluster/remote"
	capierrors "github.com/getupcloud/undistro/errors"
	kubedrain "github.com/getupcloud/undistro/third_party/kubernetes-drain"
...
// +kubebuilder:rbac:groups=infrastructure.getupcloud.com;bootstrap.getupcloud.com,resources=*,verbs=get;list;watch;create;update;patch;delete
