...
import (
	...
	"github.com/getupcloud/undistro/internal/docker"
...
// +kubebuilder:rbac:groups=infrastructure.getupcloud.com,resources=dockerclusters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=infrastructure.getupcloud.com,resources=dockerclusters/status,verbs=get;update;patch
