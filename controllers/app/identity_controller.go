...
//+kubebuilder:rbac:groups=app.undistro.io,resources=identities,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=app.undistro.io,resources=identities/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=app.undistro.io,resources=identities/finalizers,verbs=update
