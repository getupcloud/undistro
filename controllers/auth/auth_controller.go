...
//+kubebuilder:rbac:groups=auth.undistro.io,resources=auths/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=auth.undistro.io,resources=auths/finalizers,verbs=update
